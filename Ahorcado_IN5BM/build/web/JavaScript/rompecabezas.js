...
let piezas = [
    contextPath + "/Images/split-1.png", contextPath + "/Images/split-2.png", contextPath + "/Images/split-3.png", contextPath + "/Images/split-4.png",
    contextPath + "/Images/split-5.png", contextPath + "/Images/split-6.png", contextPath + "/Images/split-7.png", contextPath + "/Images/split-8.png",
    contextPath + "/Images/split-9.png", contextPath + "/Images/split-10.png", contextPath + "/Images/split-11.png", contextPath + "/Images/split-12.png",
    contextPath + "/Images/split-13.png", contextPath + "/Images/split-14.png", contextPath + "/Images/split-15.png", ""];
let estado = [];
...
function irAlIndex() {
    ...
    window.location.href = "Controlador?menu=PrincipalRompecabezas";
}

function otroPuzzle1() {
    alert("Cargando el otro puzzle...");
    window.location.href = "Controlador?menu=Rompecabezas2";
}

function otroPuzzle2() {
    alert("Cargando el otro puzzle...");
    window.location.href = "Controlador?menu=Rompecabezas3";
}
