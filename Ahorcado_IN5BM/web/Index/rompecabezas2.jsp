    ...
    <body>
        <div class="game-wrapper">
            <header class="main-header">
                <h1 class="header-title">Gato yu Tiburon el PUZZLE</h1>
                ...
                <div class="left-panel">
                    ...
                    <div class="image-container">
                        ...
                        <div class="reference-image" id="referenceImage">
                            <img src="${pageContext.request.contextPath}/Images/GatoTiburon.jpg" alt="alt"/>
                        </div>
                ...
                <div class="right-panel">
                    <div class="puzzle-container">
                        ...
                        <div class="instructions">
                            ...
                            <p>Haz clic en una pieza adyacente al espacio negro para deslizarla hacia ese espacio. Tu objetivo es ordenar todas las piezas para formar la imagen completa del Gato Loko y su tiburon antes de que se agote el tiempo.</p>
        ...
        <script src="${pageContext.request.contextPath}/JavaScript/rompecabezas2.js"></script>
