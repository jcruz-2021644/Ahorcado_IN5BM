...
let piezas = [
    contextPath + "/Images/Dios1.png", contextPath + "/Images/Dios2.png", contextPath + "/Images/Dios3.png", contextPath + "/Images/Dios4.png",
    contextPath + "/Images/Dios5.png", contextPath + "/Images/Dios6.png", contextPath + "/Images/Dios7.png", contextPath + "/Images/Dios8.png",
    contextPath + "/Images/Dios9.png", contextPath + "/Images/Dios10.png", contextPath + "/Images/Dios11.png", contextPath + "/Images/Dios12.png",
    contextPath + "/Images/Dios13.png", contextPath + "/Images/Dios14.png", contextPath + "/Images/Dios15.png", ""];
let estado = [];
