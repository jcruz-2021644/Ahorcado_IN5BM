...
//Importaciones extras para el otro mini servidor HTTP
...
public class ProyectoSpringAhorcadoApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        try {
            ...
            if (puertoOcupado) { //Si el puerto esta ocupado
                ...
                System.err.println("Lo sentimos el puerto " + puerto1 + " ya se encuentra en uso. Levantaremos un mini-servidor en el puerto " + puerto2);
    ...
    private static int leerPuertoProperties() {
        ...
        try (java.io.InputStream is = ProyectoSpringAhorcadoApplication.class
